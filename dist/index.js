...
/* harmony import */ var octokit__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(158);
/* harmony import */ var octokit__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__nccwpck_require__.n(octokit__WEBPACK_IMPORTED_MODULE_0__);
...
const repo = (0,_actions_core__WEBPACK_IMPORTED_MODULE_1__.getInput)("")
const owner = "Adatree"

const octokit = new octokit__WEBPACK_IMPORTED_MODULE_0__.Octokit({auth})

await octokit.request('GET /repos/{owner}/{repo}/dependabot/alerts{?state,severity,ecosystem,package,manifest,scope,sort,direction,page,per_page,before,after,first,last}', {
  owner,
  repo
})
